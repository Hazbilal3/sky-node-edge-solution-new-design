...
const cfg: SolutionConfig = {
  ...
  heroSub: 'Skynode nodes offer broadcast operators a real alternative to legacy tower agreements — urban elevation, owned and managed infrastructure, and the operational clarity that primary transmission sites demand.',
  heroCard: {
    title: 'FM Primary Site — What to Expect',
    items: [
  ...
  trust: {
    ...
    body: 'Most tower agreements were written for the tower owner\'s benefit. Skynode is built around what a broadcast operator actually needs — clear specs, real access, and infrastructure that isn\'t shared with a dozen other signals fighting for the same space.',
    features: [
      { title: 'Elevation matched to your coverage requirements', body: 'Site elevation data is provided upfront — not buried in a lease addendum. We evaluate each node against your specific coverage pattern before any engagement begins.' },
      ...
      { title: 'Backhaul that works for broadcast', body: 'STL and IP audio backhaul options are assessed for each node — fiber availability, point-to-point path viability, and Metro Fabric interconnection where applicable.' },
  ...
  useCases: [
    ...
    { name: 'New market entry for FM operators', body: 'Stations entering a new market or expanding operations can qualify a Skynode site early in the process — before committing to lease terms that are difficult to exit.', tags: ['FM', 'New Market', 'Greenfield'] },
    ...
    { name: 'Backup site qualifying as primary', body: 'Operators who originally placed a node for backup purposes sometimes find the elevation and RF environment qualify it for primary use — particularly in competitive RF markets.', tags: ['FM', 'Upgrade', 'Dual-Use'] },
  ],
  related: [
