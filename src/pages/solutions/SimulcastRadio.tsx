...
const cfg: SolutionConfig = {
  ...
  heroSub: 'Simulcast networks deliver seamless coverage across wide areas by synchronizing transmitters across multiple sites. The infrastructure requirements are demanding â€” GPS timing, low-latency backhaul, precise RF planning. Skynode nodes are evaluated against these exacting standards.',
  heroCard: {
  ...
  trust: {
    ...
    body: 'Simulcast systems fail when backhaul latency variation (jitter) exceeds system tolerance, GPS signals are unreliable, or RF overlap zones are poorly planned. Skynode addresses all three â€” GPS confirmation, backhaul latency measurement, and RF environment assessment â€” before any equipment goes on site.',
    features: [
      { title: 'GPS timing confirmation per site', body: 'Every Skynode simulcast candidate node is evaluated for GPS signal availability â€” rooftop access, sky view clarity, and signal quality â€” so timing-sensitive simulcast systems get the synchronization they need.' },
      ...
      { title: 'Metro Fabric for inter-site coordination', body: 'Where multiple Skynode nodes are active in the same market, Metro Fabric provides a private, low-latency interconnection path between simulcast sites â€” reducing dependence on public internet paths for timing-critical traffic.' },
  ...
  useCases: [
    ...
    { name: 'Public safety simulcast expansion', body: 'Public safety P25 trunked systems expanding coverage across municipal or county boundaries often need additional simulcast transmitter sites â€” Skynode nodes can fill gaps in the existing site network.', tags: ['Public Safety', 'P25', 'Expansion'] },
    { name: 'P25 Phase II simulcast migration', body: 'P25 Phase II TDMA trunked systems require the same simulcast infrastructure as Phase I â€” with the added complexity of TDMA slot synchronization. Skynode evaluates nodes against Phase II timing requirements.', tags: ['P25', 'Phase II', 'TDMA'] },
