...
const cfg: SolutionConfig = {
  ...
  heroSub: 'Hyperscale cloud infrastructure is optimized for scale â€” not for proximity to your users. Enterprise edge compute at Skynode nodes puts processing capacity where latency is lowest: within the urban markets where your customers, employees, and operations live.',
  heroCard: {
  ...
  trust: {
    ...
    body: 'Cloud regions are getting closer, but they\'re still not in your city. Edge compute at a Skynode node can be 5â€“15ms closer to your users than the nearest cloud availability zone â€” and for real-time AI inference, video processing, and latency-sensitive enterprise applications, that distance matters.',
    features: [
      { title: 'Urban positioning reduces application latency', body: 'Edge nodes within a metropolitan area are physically closer to end users than regional cloud infrastructure. For applications where response time is perceptible â€” AI assistants, real-time analytics, interactive applications â€” the distance reduction translates directly into better user experience.' },
      { title: 'AI inference at the edge', body: 'Running inference models at edge nodes reduces the round-trip to a centralized AI service â€” critical for real-time applications. Skynode evaluates each node for the power density and cooling capacity that GPU inference workloads require.' },
      { title: 'Data sovereignty and processing locality', body: 'Regulated industries and privacy-conscious organizations benefit from processing data within a specific market rather than routing it through centralized cloud infrastructure â€” edge nodes provide the geographic control that compliance requirements demand.' },
  ...
  useCases: [
    ...
    { name: 'Private 5G edge processing', body: 'Private 5G deployments colocating mobile edge compute (MEC) infrastructure alongside radio access equipment â€” processing IoT and industrial data before it leaves the deployment site.', tags: ['Private 5G', 'MEC', 'IoT'] },
