...
const cfg: SolutionConfig = {
  ...
  heroSub: 'Point-to-point microwave links move data at speeds that fiber-competitive alternatives can match â€” without waiting for fiber deployment. Skynode nodes provide the elevation, line-of-sight paths, and backhaul access that high-capacity P2P link deployments require.',
  heroCard: {
  ...
  trust: {
    ...
    body: 'Fiber deployment timelines are often measured in months or years. Licensed microwave point-to-point links can deliver gigabit-class throughput on a timeline measured in weeks â€” using elevation on Skynode nodes to establish clear line-of-sight paths between your locations.',
    features: [
      { title: 'Multi-Gbps throughput on licensed frequencies', body: 'Licensed microwave bands in the 6â€“23 GHz range support throughput from hundreds of megabits to multi-gigabit â€” sufficient for most enterprise backhaul, broadcast contribution, and high-density data applications.' },
      { title: 'Sub-millisecond latency per hop', body: 'Point-to-point microwave links deliver consistent sub-millisecond one-way latency â€” important for financial trading systems, real-time media delivery, and latency-sensitive enterprise applications.' },
      { title: 'Path confirmation before commitment', body: 'Path viability is confirmed using terrain analysis and line-of-sight modeling before any equipment or lease commitment is made â€” you know the link will work before you commit resources to it.' },
      { title: 'Link aggregation and redundancy options', body: 'Critical paths can be protected using parallel links on different frequencies or with route diversity â€” providing link redundancy that fiber routes typically can\'t match in dense urban environments.' },
    ],
  },
  specs: [
  ...
  useCases: [
    { name: 'Broadcast contribution feed backhaul', body: 'Broadcast networks moving high-bitrate video contribution feeds between production facilities and transmission sites need reliable gigabit-class backhaul â€” P2P microwave provides it without carrier circuit complexity.', tags: ['Broadcasting', 'Contribution', 'Video'] },
