...
const cfg: SolutionConfig = {
  ...
  heroSub: 'Translators and boosters expand coverage into urban signal shadows and suburban gaps â€” but they need the right elevation and RF environment to work. Skynode nodes are evaluated specifically for translator and booster suitability across all four Skynode markets.',
  heroCard: {
  ...
  trust: {
    ...
    body: 'Urban canyons, building shadows, and terrain obstructions create coverage gaps that translators and boosters were designed to fill. Getting the site right â€” elevation, receive quality, backhaul â€” determines whether a translator project actually solves the problem or creates a new one.',
    features: [
      { title: 'Off-air receive path evaluation', body: 'Translator operation depends on reliable off-air reception of the parent station. Skynode evaluates the receive environment at each candidate node â€” line of sight to primary antenna, interference potential, and signal level estimates.' },
      { title: 'Urban fill gap analysis', body: 'We can help identify which nodes in a market are positioned to fill specific coverage gaps â€” useful for operators planning translator deployments before committing to a specific site.' },
  ...
  useCases: [
    ...
    { name: 'HD Radio translator deployment', body: 'HD Radio simulcast translators converting IBOC service to a separate analog frequency â€” require the same receive and transmit infrastructure as standard FM translators.', tags: ['Translator', 'HD Radio', 'IBOC'] },
