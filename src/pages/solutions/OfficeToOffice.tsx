...
const cfg: SolutionConfig = {
  ...
  heroSub: 'Carrier circuits are expensive, slow to provision, and built for someone else\'s priorities. Skynode nodes give multi-location organizations a private point-to-point microwave path between offices â€” faster to provision, lower recurring cost, and completely off the public internet.',
  heroCard: {
  ...
  trust: {
    ...
    body: 'When your offices are connected through carrier circuits, the carrier controls the path, the uptime SLA, and the provisioning timeline. A Skynode-based microwave link between offices puts your organization in control â€” and eliminates the monthly recurring cost of a leased line or MPLS circuit.',
    features: [
      { title: 'Private path â€” completely off the public internet', body: 'Microwave point-to-point links are Layer 1 â€” there\'s no packet routing through third-party networks, no shared internet infrastructure, and no exposure to the traffic and threats of the public internet.' },
      { title: 'Path viability confirmed before engagement', body: 'We confirm line-of-sight viability between proposed endpoints before any equipment or lease discussion begins â€” no surprises after you\'ve committed to the infrastructure plan.' },
      { title: 'Faster provisioning than carrier circuits', body: 'Carrier circuit orders take weeks to months. A point-to-point microwave link between two Skynode nodes can be provisioned significantly faster â€” typically measured in days to weeks once site qualification is complete.' },
  ...
  useCases: [
    { name: 'Headquarters to branch office connectivity', body: 'Organizations with a primary office and one or more branches within a Skynode market can replace carrier circuits with a private microwave link â€” lower cost, higher control.', tags: ['Enterprise', 'HQ-Branch', 'Private Network'] },
    ...
    { name: 'Disaster recovery primary-to-DR link', body: 'Organizations maintaining a disaster recovery facility need a reliable, low-latency path between primary and DR sites â€” a private microwave link eliminates internet-path risk for DR replication traffic.', tags: ['DR', 'Resilience', 'Replication'] },
  ],
  related: [
