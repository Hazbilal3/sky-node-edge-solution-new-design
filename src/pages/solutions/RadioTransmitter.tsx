...
const cfg: SolutionConfig = {
  ...
  heroSub: 'Two-way radio systems depend on transmitter site quality â€” height, coverage, backhaul, and power. Skynode nodes are evaluated for the specific requirements of conventional and trunked radio transmitter deployments across all four Skynode markets.',
  heroCard: {
  ...
  trust: {
    ...
    body: 'Radio system operators need more than height â€” they need a site partner who understands the operational reality of two-way communications infrastructure. Skynode nodes are evaluated for the RF environment, backhaul paths, and power characteristics that make transmitter sites work long-term.',
    features: [
      { title: 'Coverage-first elevation evaluation', body: 'We evaluate each node against your specific coverage requirements â€” not just height above grade. HAAT estimates, terrain analysis, and coverage modeling inputs are provided during qualification.' },
  ...
  useCases: [
    ...
    { name: 'Remote and field operations coverage', body: 'Organizations that need radio coverage in areas their existing system doesn\'t reach â€” construction sites, remote facilities, event venues â€” can qualify Skynode nodes for temporary or permanent fill.', tags: ['Field Ops', 'Coverage Fill', 'Temporary'] },
    { name: 'System expansion transmitter', body: 'Radio systems growing beyond their existing coverage footprint need additional transmitter sites â€” Skynode provides a qualified path to expansion without building a tower.', tags: ['Expansion', 'Coverage', 'Additional Site'] },
  ],
  related: [
