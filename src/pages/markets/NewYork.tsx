...
export default function NewYork() {
  return <MarketPage cfg={{
    ...
    nodes: [
      { id:'0302.NY', neighborhood:'Midtown Manhattan',  svcs:['Broadcasting','Edge Colocation','AI / Inference','P2P Links'], status:'active'     },
      { id:'0118.NY', neighborhood:'Brooklyn Heights',   svcs:['Broadcasting','Private Comms','IoT / Sensors'],               status:'active'     },
      { id:'0445.NY', neighborhood:'Long Island City',   svcs:['Private Comms','Private 5G','P2P Links'],                    status:'active'     },
