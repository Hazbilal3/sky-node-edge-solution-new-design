        ...
        <div className="container">
          ...
          <div className="hiw-faq-grid">
            {[
              ...
              { q:'Why are some specifications listed as "Per site"?',  a:'These specifications vary by node and are confirmed during site evaluation for your specific engagement. We list them as per-site rather than publish figures we haven\'t verified for a specific location.' },
