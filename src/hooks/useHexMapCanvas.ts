...
const CITY_DATA: Array<{name:string; nodes:HexNode[]}> = [
  { name:'NYC', nodes:[
    {col:11,row:7, type:'FM',         id:'0312.NY', asl:"TBC", svc:['FM','TV']},
    {col:12,row:6, type:'FM',         id:'0328.NY', asl:"TBC", svc:['FM','Translator']},
    {col:10,row:7, type:'Translator', id:'0331.NY', asl:"TBC", svc:['Translator','FM']},
    {col:11,row:8, type:'LPFM',       id:'0329.NY', asl:"TBC", svc:['LPFM']},
    {col:12,row:7, type:'TV',         id:'0332.NY', asl:"TBC", svc:['TV','FM']},
    {col:13,row:8, type:'TV',         id:'0335.NY', asl:"TBC", svc:['TV']},
    {col:10,row:9, type:'LPFM',       id:'0337.NY', asl:"TBC", svc:['LPFM','Translator']},
  ]},
  { name:'Chicago', nodes:[
    {col:11,row:7, type:'TV',         id:'0327.IL', asl:"TBC", svc:['TV','FM']},
    {col:12,row:6, type:'FM',         id:'0318.IL', asl:"TBC", svc:['FM']},
    {col:10,row:8, type:'Translator', id:'0319.IL', asl:"TBC", svc:['Translator','LPFM']},
    {col:12,row:8, type:'LPFM',       id:'0318.IL', asl:"TBC", svc:['LPFM']},
    {col:11,row:9, type:'FM',         id:'0327.IL', asl:"TBC", svc:['FM','TV']},
  ]},
  { name:'Miami', nodes:[
    {col:11,row:7, type:'FM',         id:'0333.FL', asl:"TBC", svc:['FM','TV']},
    {col:12,row:6, type:'Translator', id:'0383.FL', asl:"TBC", svc:['Translator']},
    {col:10,row:7, type:'LPFM',       id:'0302.FL', asl:"TBC", svc:['LPFM','FM']},
    {col:11,row:8, type:'TV',         id:'0333.FL', asl:"TBC", svc:['TV']},
    {col:12,row:8, type:'FM',         id:'0383.FL', asl:"TBC", svc:['FM','Translator']},
  ]},
